...
void startNFCSession(String dialogMsg) {
  if(Platform.isIOS) {
    UniLinksPlatform.instance.getMethodChannel().invokeMethod('startNFCSession', dialogMsg);
  }
}
...
void stopNFCSession() {
  if(Platform.isIOS) {
    UniLinksPlatform.instance.getMethodChannel().invokeMethod('stopNFCSession');
  }
}